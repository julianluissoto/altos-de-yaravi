...
export const metadata: Metadata = {
  ...
  description: 'Descubre nuestras cabañas en Embalse de Calamuchita, Córdoba. Un lugar ideal para el descanso, la naturaleza y la aventura. ¡Reserva tu estancia!',
};
